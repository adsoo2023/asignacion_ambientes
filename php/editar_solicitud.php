...
<div class="card">
        ...
        <form method="POST" autocomplete="off">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="numero_ficha" name="numero_ficha" value="<?php echo $numero_ficha; ?>"><br>
            </div>

            <div class="form-group">
                <label for="formacion">Formación:</label>
                <input type="text" class="form-control" id="formacion" name="formacion" value="<?php echo $formacion; ?>"><br>
            </div>

            <div class="form-group">
                <label for="motivo">Motivo:</label>
                <input type="text" id="motivo" class="form-control" name="motivo" value="<?php echo $motivo; ?>">
            </div>
