...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = mysqli_query($conexion, "INSERT INTO reporteactual_ambiente (id_asignacion, fecha_actual_reporte, estado_reporte, id_usuario) 
VALUES ('$ambiente', '$fecha', '$descrip', '$id')");
$data = array(
    'success' => true
);
